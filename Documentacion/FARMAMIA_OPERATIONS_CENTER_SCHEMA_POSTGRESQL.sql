...
-- Esquema PostgreSQL canonico del MVP de actualizacion POS.
-- Refleja el estado acumulado de las migraciones Flyway V1 a V5.
-- Las migraciones ejecutables viven en:
...
CREATE INDEX ix_alerts_opened_at ON alerts(opened_at);
...
-- La migracion V3 puede crear el usuario admin/admin123 solo cuando
-- el placeholder Flyway seed-demo-admin esta en true. En QA/PROD debe
-- estar en false mediante FARMAMIA_SEED_DEMO_ADMIN=false.
