...
import com.farmamia.posupdate.presentacion.dto.RespuestaOleadaOrquestacion;
import com.farmamia.posupdate.presentacion.dto.RespuestaPlanOrquestacion;
...
public class ControladorOrquestacionDespliegues {
    ...
    public RespuestaPlanOrquestacion planificar(
        ...
        @RequestBody(required = false) com.farmamia.posupdate.presentacion.dto.SolicitudPlanOrquestacion solicitud,
        ...
        RespuestaPlanOrquestacion respuesta = aRespuesta(orquestarDesplieguesCasoUso.planificar(
            deploymentId,
            new com.farmamia.posupdate.dominio.modelo.SolicitudPlanOrquestacion(
